module.exports = {
    ...
    MARK_ALL_PAID: 'Money Successfully Paid',
    APPROVE_CHORE_FIRST: 'Please approve the chore record first',
    MARKED_AS_PAID_SUCCESS: 'Chore marked as paid successfully',
    microservice: {
        baseurl_not_found: 'baseUrl not found'
    },
    unauthorized: {
